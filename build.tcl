...
#
# build.tcl: Tcl script for re-creating project 'EthernetFun'
#
# Generated by Vivado on Thu Nov 29 18:37:45 -0800 2018
...
#
#    "D:/github/EthernetFun/EthernetFun.srcs/sources_1/bd/design01/hdl/design01_wrapper.vhd"
#    "D:/github/EthernetFun/EthernetFun.srcs/constrs_1/new/constraints.xdc"
#
...
set files [list \
 "[file normalize "$origin_dir/EthernetFun.srcs/sources_1/bd/design01/hdl/design01_wrapper.vhd"]"\
]
...
set file "hdl/design01_wrapper.vhd"
...
set_property -name "top" -value "design01_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/EthernetFun.srcs/constrs_1/new/constraints.xdc"]"
...
# Proc to create BD design01
proc cr_bd_design01 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name design01
...
# End of cr_bd_design01()
cr_bd_design01 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files design01.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files design01.bd ] 
set_property IS_ENABLED "1" [get_files design01.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files design01.bd ] 
set_property IS_LOCKED "0" [get_files design01.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files design01.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files design01.bd ] 
set_property PFM_NAME "" [get_files design01.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design01.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files design01.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files design01.bd ] 
set_property USED_IN_SIMULATION "1" [get_files design01.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files design01.bd ] 
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z020clg484-1 -flow {Vivado Implementation 2017} -strategy "impl_2" -constrset constrs_1 -parent_run synth_1
} else {
  set_property strategy "impl_2" [get_runs impl_1]
...
set_property -name "strategy" -value "impl_2" -objects $obj
